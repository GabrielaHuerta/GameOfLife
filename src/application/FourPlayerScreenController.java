...
public class FourPlayerScreenController
{
	...
	@FXML
	private TextField gender4;
	@FXML
	private TextField color4;
	...
	{
		players.add(3,new Player(name4.getText(),gender4.getText(),color4.getText()));
	}
	...
	public void openBoard(ActionEvent event)
	{
		try 
		{
			Parent root = FXMLLoader.load(getClass().getResource("/application/Board4.fxml"));
