...
public class Board2Controller extends TwoPlayerScreenController
{
	private int count = 0; 
	...
	@FXML
	public Label genderPlayer1; 

	@FXML 
	public Label homePlayer1; 

	@FXML
	public Label careerPlayer1; 
	...
	@FXML
	public Label genderPlayer2; 

	@FXML 
	public Label homePlayer2; 

	@FXML
	public Label careerPlayer2; 
	...
	private void displayCareerInfo()
	{
		...
		careerPlayer1.setText("Career: " + getCollegeCareer(one));
		careerPlayer2.setText("Career: " + getNonCollegeCareer(two));
	}

	//really intense method 
	private void action(Player play, ArrayList<Coordinates>list, int loc)
	{
		if(list.get(loc).getIdentifaction().equals("y"))
		{
			...
			if(play.getName().equals(one.getName()))
				moneyPlayer1.setText("Money: $"  + one.getTotalMoney()); 
			else
				moneyPlayer2.setText("Money: $"  + two.getTotalMoney());

		}
		else if(list.get(loc).getIdentifaction().equals("h"))
		{
		...
		else if(list.get(loc).getIdentifaction().equals("t"))
		{
			play.addChildren(2);
			if(play.getName().equals(one.getName()))
				childrenPlayer1.setText("Children # : " + one.getNumOfChildren());
			else
				childrenPlayer2.setText("Children # : " + two.getNumOfChildren());	
		}
		else if(list.get(loc).getIdentifaction().equals("b"))
		{
			play.addChildren(1);
			if(play.getName().equals(one.getName()))
				childrenPlayer1.setText("Children # : " + one.getNumOfChildren());
		...
		else if(list.get(loc).getIdentifaction().equals("g"))
		{
		...
		else if(list.get(loc).getIdentifaction().equals("m"))
		{
			play.getMarried();
			if(play.getName().equals(one.getName()))
				marriedPlayer1.setText("Married? : " + one.isMarried());
			else
				marriedPlayer2.setText("Married? : " + two.isMarried());
		}
		else if(list.get(loc).getIdentifaction().equals("+200K"))
		{
		...
		else if(list.get(loc).getIdentifaction().equals("-100K"))
		{
		...
		else if(list.get(loc).getIdentifaction().equals("+300K"))
		{
	...
	public void spin(ActionEvent event)
	{
		...
		{
			movePlayer1(rand); 
			action(one, listA, locPlayer1);
		}
		else
		{
			movePlayer2(rand); 
			action(two, listB, locPlayer2); 
		}
